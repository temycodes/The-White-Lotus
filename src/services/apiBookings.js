...
// Get all bookings and accept filter and sortby to customize the query, cabins(name) and guests(fullName, email) are foreign keys.
export async function getBookings({ filter, sortBy, page }) {
  ...
  //sort
  if (sortBy)
    // order is a supabase method to sort results
...
export async function getStaysTodayActivity() {
  ...
  // data returned will be an array of bookings that have check in or check out today
}
